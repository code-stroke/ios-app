...
enum CodeStrokeProvider {
    ...
    case setClinicalInfo(pmhx: String, anticoags_last_dose: String, meds: String, anticoags: Bool, hopc: String, weight: Float, last_meal: String)
...
extension CodeStrokeProvider: TargetType {
    ...
    var method: Moya.Method {
        switch self {
        case .register, .pair, .setPassword:
            return .post
        case .login, .caseList, .getEDInfo, .getPatientInfo, .getClinicalInfo, .getClinicalAssessmentInfo, .getRadiologyInfo, .getManagementInfo:
            return .get
        case .setEDInfo, .setPatientInfo, .setClinicalInfo, .setClinicalAssessmentInfo, .setRadiologyInfo, .setManagementInfo:
            return .put
        }
    }
    ...
    public var authorizationType: AuthorizationType {
        ...
        case .pair:
            return .none
        case .login, .register, .setPassword, .caseList, .getEDInfo, .setEDInfo, .getPatientInfo, .setPatientInfo, .getClinicalInfo, .setClinicalInfo, .getClinicalAssessmentInfo, .setClinicalAssessmentInfo, .getRadiologyInfo, .setRadiologyInfo, .getManagementInfo, .setManagementInfo:
            return .basic
        }
    }
}
