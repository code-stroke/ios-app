...
extension ClinicalAssessmentInfoView {
    ...
    @IBAction func btnLikelyLVOClicked(_ sender: UIButton) {
        ...
        if !self.isLikelyLVO {
            ...
            self.delegate?.showAlert(withTitle: "CodeStrokeAlert", andMessage: "Likely LVO broadcast sent", isSuccess: true)
        }
    }
