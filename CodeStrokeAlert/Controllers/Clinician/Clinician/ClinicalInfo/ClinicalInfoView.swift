        ...
        NetworkModule.shared.getClinicalInfo(onSuccess: { apiResponseClinicalInfo in
            ...
            if let anticoags = apiResponseClinicalInfo.clinicalInfoArray[0].anticoags {
                ...
                if anticoags == "unknown" {
                    ...
                    self.clearAllAndSelected(buttons: [self.btnAnticoagulantsYes, self.btnAnticoagulantsNo, self.btnAnticoagulantsUnknown], selectedButton: self.btnAnticoagulantsUnknown)
                    
                } else if anticoags == "no" {
                    
                    self.clearAllAndSelected(buttons: [self.btnAnticoagulantsYes, self.btnAnticoagulantsNo, self.btnAnticoagulantsUnknown], selectedButton: self.btnAnticoagulantsNo)
                    
                } else {
                    
                    self.clearAllAndSelected(buttons: [self.btnAnticoagulantsYes, self.btnAnticoagulantsNo, self.btnAnticoagulantsUnknown], selectedButton: self.btnAnticoagulantsYes)
                }
            }
...
extension ClinicalInfoView {
    ...
    @IBAction func btnSubmitClicked(_ sender: UIButton) {
        ...
        NetworkModule.shared.setClinicalInfo(pmhx: self.txtPastMedicalHistory.text!, anticoags_last_dose: self.strLastDoseDate, meds: self.txtMedication.text!, anticoags: self.btnAnticoagulantsUnknown.isSelected ? "unknown" : (self.btnAnticoagulantsYes.isSelected ? "yes" : "no"), hopc: self.txtSituation.text!, weight: Float(strWeight)!, last_meal: self.strLastMealDate, onSuccess: { apiResponseClinicalInfo in
    ...
    @IBAction func btnAnticoagulantsClicked(_ sender: UIButton) {
        ...
        self.clearAllAndSelected(buttons: [self.btnAnticoagulantsYes, self.btnAnticoagulantsNo, self.btnAnticoagulantsUnknown], selectedButton: sender)
    }
}
