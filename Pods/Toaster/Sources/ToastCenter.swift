...
open class ToastCenter {
    ...
    init() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(self.deviceOrientationDidChange), name: NSNotification.Name(rawValue: "UIDeviceOrientationDidChange"), object: nil)
    }
